...
int main()
{
    ...
    } while (fraction3.denomerator == 0 || fraction2.denomerator == 0 || fraction1.denomerator == 0);
    ...
    {                                       // Programmet
        ...
        while (svar != 'q')
        {
            if (svar == 'a')                // Gjør om temp1 og 2 til 
            {                               // brukerens valgte brøker
                temp1 = fraction1;
        ...
        } while(opperasjon != '+' && opperasjon != '-' && 
                opperasjon != '*' && opperasjon != '/');
        
        if (opperasjon == '+')   // Regner ut og printer ut
        ...
        } else if (opperasjon == '-') // Gjør det samme for alle
        {                                            // opperasjonene.
        ...
        } else if (opperasjon == '*')    // Multplikasjon
        {
